...
public class AdminTransDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_trans_detail);
        ...
        TextView semester = findViewById(R.id.valSemester);
        ...
        if(cursor.moveToFirst()){
            do{
                ...
                String valSemester = cursor.getString(cursor.getColumnIndexOrThrow("semester"));
    ...
    private void showConfrimProsesDialog(){
        AlertDialog.Builder builder = new AlertDialog.Builder(AdminTransDetailActivity.this);
    ...
    private void updateProses(){
        ...
        Intent result = new Intent(getApplicationContext(), AdminTransListActivity.class);
